...
/*!
 * @file ProcessingExampleComp.java
...
/**
 * ProcessingExampleComp
 * <p>
 * Standalone component Class
 *
 */
public class ProcessingExampleComp implements ModuleInitProc {
    String m_instanceName = new String(""); 

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(processingexample_conf);
      mgr.registerFactory(prop, new ProcessingExample(), new ProcessingExample());
      ...
      // Create a component
      RTObject_impl comp = mgr.createComponent("ProcessingExample" + arg);
      if( comp==null ) {
